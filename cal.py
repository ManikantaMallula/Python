...
button_sub=Button(root, text="-", padx=40, pady=20, command=button_sub).grid(row=4, column=2, )
button_mul=Button(root, text="*", padx=39, pady=20, command=button_mul).grid(row=5, column=0, )
button_div=Button(root, text="/", padx=39, pady=20, command=button_div).grid(row=5, column=1, )


button_equal=Button(root, text="=", padx=39, pady=20, command=button_equal).grid(row=5, column=2)
