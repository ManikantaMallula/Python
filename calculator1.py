...
root=Tk()
root.title("sahoo's Calculator")

e=Entry(root,width=35,borderwidth=10)
e.grid(row=0, column=0, columnspan=10, pady=10)
...
button_div=Button(root, text="/", padx=40, pady=20, command=button_div).grid(row=5, column=1, )


button_equal=Button(root, text="=", padx=40, pady=20, command=button_equal).grid(row=5, column=2)
button_clear=Button(root, text="clear", padx=40, pady=20, command=button_clear).grid(row=6, column=0,)
