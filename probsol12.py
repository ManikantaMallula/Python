...
2.accelerate:
    when car accelerates then nitro points are available the current_speed will be add 20 within max limits and nitro get reduced by 1 point 
...
##class Car:
##    def __init__(self,color,max_speed,acceeleration,tyre_friction,is_engine_started,current_speed):
##        self.color=color
...
##        else:
##            self.current_speed+=self.acceeleration
