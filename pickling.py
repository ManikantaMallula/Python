...
whose name is passed as an argument. Structure stored in “school.dat” is in the form of list containing information like
...
##class S:
##    def __init__(self,n,r,c,p):
##        self.n=n
##        self.r=r
##        self.c=c
##        self.p=p
##    def show(self):
##        print(self.n,self.r,self.c,self.p)
##s=S("alex",101,"8th",85)
##with open("stdnt.txt","wb") as f:
##    dump(s,f)
##    print("pickling is successfull")
...
whose model number (integer type) is passed as an argument. Structure of “mobile.dat” is [Mobile id, Mobile brand, Model No., Price '''
