...
'''
Consider a binary file “data.dat” which stores the record of “Hotel” in the form of list containing Room_no, Price, Room_type.
...
##from pickle import *
##class Pick:
##     def __init__(self,hno,sname,lm):
##          self.hno=hno
##          self.sname=sname
##          self.lm=lm
##     def disp(self):
##          print(self.hno,self.sname,self.lm)
##p=Pick(123,"bankcolony street","anu's gils hostle")
##          
##with open("p2.txt","ab") as f:
##     dump(p,f)
